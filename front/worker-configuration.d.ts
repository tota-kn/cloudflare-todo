/* eslint-disable */
// Generated by Wrangler by running `wrangler types -e local` (hash: 3d7bfc8a3c26769ea54efae43a4265bf)
// Runtime types generated with workerd@1.20250816.0 2025-04-04 
declare namespace Cloudflare {
	interface Env {
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare Local" | "Hello from Cloudflare Dev" | "Hello from Cloudflare Production";
		API_BASE_URL: "http://localhost:8787" | "https://todo-back-dev.omen-bt.workers.dev" | "https://todo-back-prd.omen-bt.workers.dev";
		IS_LOCAL: true | false;
		BACKEND_API: Fetcher /* todo-back-local */;
	}
}
